"use client"  // Marks this file for client-side rendering (required for hooks like useState)
...
export function CopyEventButton({
    ...
    const [copyState, setCopyState] = useState<CopyState>('idle') // Manage the copy feedback
